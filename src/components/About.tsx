    ...
    <section id="about" className="py-20 px-6 bg-white dark:bg-gray-800">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4 p-6 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/30 dark:to-purple-900/30 rounded-lg">
              <GraduationCap className="text-blue-600 dark:text-blue-400 mt-1" size={24} />
              <div>
                <h3 className="font-semibold text-gray-800 dark:text-gray-100 mb-2">Education Focus</h3>
            ...
            <div className="flex items-start gap-4 p-6 bg-gradient-to-r from-purple-50 to-blue-50 dark:from-purple-900/30 dark:to-blue-900/30 rounded-lg">
              <Code className="text-purple-600 dark:text-purple-400 mt-1" size={24} />
              <div>
                <h3 className="font-semibold text-gray-800 dark:text-gray-100 mb-2">Technical Expertise</h3>
                <p className="text-gray-600 dark:text-gray-300">
            ...
            <div className="flex items-start gap-4 p-6 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/30 dark:to-purple-900/30 rounded-lg">
              <Target className="text-blue-600 dark:text-blue-400 mt-1" size={24} />
              <div>
                <h3 className="font-semibold text-gray-800 dark:text-gray-100 mb-2">Career Goal</h3>
                <p className="text-gray-600 dark:text-gray-300">
